...
# First, let's see what columns we have and identify categorical ones
...
# Handle all categorical features using one-hot encoding
if categorical_cols:
    X = pd.get_dummies(X, columns=categorical_cols, drop_first=True)
    print(f"After encoding, we have {X.shape[1]} features: {X.columns.tolist()}")
